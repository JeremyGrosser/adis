...
--     DIS_PDU_Pointer_Types, Errors, Gateway_Interface, Math, Numeric_Types,
--     OS_Data_Types, OS_GUI, OS_Hash_Table_Support, OS_Status, and
...
begin -- Determine_Detonation_Result
   ...
   if not Entity_Impact_Occurred then
      -- Get height above terrain using ModSAF terrain database
      ...
      elsif Height_Above_Terrain <= OS_Hash_Table_Support.
