...
--  *====================================================================*
--
-- PACKAGE NAME :      Gateway_Interface (spec)
--
...
package Gateway_Interface is

   -- Gateway Types
   type SMPDU_HEADER_TYPE is
     record
       PDU_Header            :  DIS_Types.A_PDU_HEADER;
       Originating_Entity_ID :  DIS_Types.AN_ENTITY_IDENTIFIER;
       Originating_Group     :  Numeric_Types.UNSIGNED_16_BIT;
       Receiving_Entity_ID   :  DIS_Types.AN_ENTITY_IDENTIFIER;
       Receiving_Group       :  Numeric_Types.UNSIGNED_16_BIT;
     end record;

   type SMPDU_HEADER_TYPE_PTR is access SMPDU_HEADER_TYPE;

   -- Instantiate generics
   function Generic_Ptr_to_SMPDU_Header_Ptr
     is new Unchecked_Conversion(
       DG_Generic_PDU.GENERIC_PDU_POINTER_TYPE,
       SMPDU_HEADER_TYPE_PTR);
