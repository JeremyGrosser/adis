...
------------------------------------------------------------------------------
--
-- UNIT NAME        : DG_Client.Get_First_Simulation_Laser
--
-- FILE NAME        : DG_Client_Get_First_Simulation_Laser.ada
--
...
begin  -- Get_First_Simulation_Laser

   Status          := DG_Status.SUCCESS;
   Laser_Info      := NULL;
   Sim_Laser_Index := 0;

   Search_For_First_Laser:
   for Search_Index in DG_Server_Interface.Interface.Simulation_Data.
     Laser_Hash_Table.Entry_Data'RANGE loop
      ...
      if (DG_Server_Interface.Interface.Simulation_Data.Laser_Hash_Table.
        Entry_Data(Search_Index).Status = DG_Hash_Table_Support.IN_USE) then
         ...
         exit Search_For_First_Laser;

      end if;

   end loop Search_For_First_Laser;
...
end Get_First_Simulation_Laser;
