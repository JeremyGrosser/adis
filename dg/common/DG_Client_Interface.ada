...
--
-- FILE NAME        : DG_Client_Interface.ada
--
...
package body DG_Client_Interface is
...
--           Mem_Key => DG_IPC_Keys.Server.Server_Client_Key,
         ...
         -- creating an object of type CURRENT_CLIENT_INTERFACE_TYPE and
         ...
         declare
            ...
            Set_Variant_Values : CURRENT_CLIENT_INTERFACE_TYPE;
         ...
         --
         Shared_Memory_Ptr.Client_Online := TRUE;

         --
         -- Set default client name
         --
         Shared_Memory_Ptr.Client_Name := "Unnamed Client      ";

      else

         --
         -- This must be the server mapping the interface.
         --
...
--           Mem_Key => DG_IPC_Keys.Client.Server_Client_Key,
   ...
   exception
      ...
      when OTHERS =>
         ...
         Status := DG_Status.CLIIF_MAP_FAILURE;
   ...
   procedure Unmap_Interface(
      ...
      --
      -- Instantiate shared memory mapping package for use with the Client/
      -- Server interface.  Define a pointer for the shared memory area.
      --
...
--              Mem_Key => DG_IPC_Keys.Server.Server_Client_Key,
   ...
   exception
      ...
      when OTHERS =>
         ...
         Status := DG_Status.CLIIF_UNMAP_FAILURE;
