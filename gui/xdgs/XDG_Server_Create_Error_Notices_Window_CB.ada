...
procedure Create_Error_Notices_Window_CB (
   ...
   K_Error_Notices_Help_String : constant STRING :=
     "This is a list of DG Server errors as they occur.";
   ...
   function "=" (left, right: XDG_Server_Types.
   ...
   function XDG_DATA_REC_PTR_to_Integer
     is new Unchecked_Conversion (
       Source => XDG_Server_Types.XDG_DATA_REC_PTR,
       Target => INTEGER);

   function XDG_ERROR_NOTICES_MONITOR_DATA_REC_PTR_to_INTEGER
     is new Unchecked_Conversion (
       Source => XDG_Server_Types.XDG_ERROR_NOTICES_MONITOR_DATA_REC_PTR,
       Target => INTEGER);
...
begin
   ...
   --
	...
	:= new XDG_Server_Types.XDG_ERROR_NOTICES_MONITOR_DATA_REC'(
	  Shell                       => Xt.XNULL,
	  Title                       => Xt.XNULL,
	...
	XDG_Server.K_Error_Notices_Window_Width);
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xtdef.Nheight,
	XDG_Server.K_Error_Notices_Window_Height);
      Argcount := Argcount + 1;
	...
	XDG_Server.Close_Window_CB'address, 
	  XDG_Data.Error_Notices_Data.Shell);
	...
	Arglist, Argcount);
      ...
      --
      XDG_Server.Error_Notices_Text_Position          := Xm.TEXTPOSITION(0);
