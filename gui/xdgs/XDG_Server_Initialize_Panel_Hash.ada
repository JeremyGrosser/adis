...
procedure Initialize_Panel_Hash (
   Hash : in     XDG_Server_Types.XDG_HASH_PARAMETERS_DATA_REC) is
...
begin
   ...
   --
   if (Hash.PDU(XDG_Server_Types.ENTITY).Rehash_Increment /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
	  Entity_Hash_Table.Index_Increment),
	Return_String => Temp_String);
      Xm.TextFieldSetString (Hash.PDU(XDG_Server_Types.ENTITY).
   ...
   --
   if (Hash.PDU(XDG_Server_Types.ENTITY).Site_Multiplier /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
	  Entity_Hash_Table.Site_Multiplier),
	Return_String => Temp_String);
      Xm.TextFieldSetString (Hash.PDU(XDG_Server_Types.ENTITY).Site_Multiplier,
	Temp_String);
   end if;
   ...
   --
   if (Hash.PDU(XDG_Server_Types.ENTITY).Application_Multiplier
     /= Xt.XNULL) then
   ...
   --
   if (Hash.PDU(XDG_Server_Types.ENTITY).Entity_Multiplier /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
   ...
   --
   if (Hash.PDU(XDG_Server_Types.EMITTER).Rehash_Increment /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
	  Emission_Hash_Table.Index_Increment),
	Return_String => Temp_String);
      Xm.TextFieldSetString (Hash.PDU(XDG_Server_Types.EMITTER).
	Rehash_Increment, Temp_String);
   end if;
   ...
   --
   if (Hash.PDU(XDG_Server_Types.EMITTER).Site_Multiplier /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
   ...
   --
   if (Hash.PDU(XDG_Server_Types.EMITTER).Application_Multiplier
     /= Xt.XNULL) then
   ...
   --
   if (Hash.PDU(XDG_Server_Types.EMITTER).Entity_Multiplier /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
   ...
   --
   if (Hash.PDU(XDG_Server_Types.LASER).Rehash_Increment /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
	  Laser_Hash_Table.Index_Increment),
	Return_String => Temp_String);
      Xm.TextFieldSetString (Hash.PDU(XDG_Server_Types.LASER).Rehash_Increment,
	Temp_String);
   end if;
   ...
   --
   if (Hash.PDU(XDG_Server_Types.LASER).Site_Multiplier /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
	  Laser_Hash_Table.Site_Multiplier),
	Return_String => Temp_String);
      Xm.TextFieldSetString (Hash.PDU(XDG_Server_Types.LASER).Site_Multiplier,
	Temp_String);
   end if;
   ...
   --
   if (Hash.PDU(XDG_Server_Types.LASER).Application_Multiplier
     /= Xt.XNULL) then
	...
	Return_String => Temp_String);
      Xm.TextFieldSetString (Hash.PDU(XDG_Server_Types.LASER).
	Application_Multiplier, Temp_String);
   end if;
   ...
   --
   if (Hash.PDU(XDG_Server_Types.LASER).Entity_Multiplier /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
   ...
   --
   if (Hash.PDU(XDG_Server_Types.TRANSMITTER).Rehash_Increment /= Xt.XNULL)
     then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
	  Transmitter_Hash_Table.Index_Increment),
	Return_String => Temp_String);
      Xm.TextFieldSetString (Hash.PDU(XDG_Server_Types.TRANSMITTER).
	Rehash_Increment, Temp_String);
   end if;
   ...
   --
   if (Hash.PDU(XDG_Server_Types.TRANSMITTER).Site_Multiplier /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
   ...
   --
   if (Hash.PDU(XDG_Server_Types.TRANSMITTER).Application_Multiplier
     /= Xt.XNULL) then
   ...
   --
   if (Hash.PDU(XDG_Server_Types.TRANSMITTER).Entity_Multiplier
     /= Xt.XNULL) then
   ...
   --
   if (Hash.PDU(XDG_Server_Types.RECEIVER).Rehash_Increment /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
	  Receiver_Hash_Table.Index_Increment),
	Return_String => Temp_String);
      Xm.TextFieldSetString (Hash.PDU(XDG_Server_Types.RECEIVER).
	Rehash_Increment, Temp_String);
   end if;
   ...
   --
   if (Hash.PDU(XDG_Server_Types.RECEIVER).Site_Multiplier /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
   ...
   --
   if (Hash.PDU(XDG_Server_Types.RECEIVER).Application_Multiplier
     /= Xt.XNULL) then
   ...
   --
   if (Hash.PDU(XDG_Server_Types.RECEIVER).Entity_Multiplier /= Xt.XNULL) then
      Utilities.Integer_To_String (
	Integer_Value => INTEGER(DG_Server_GUI.Interface.Hash_Parameters.
