...
package XDG_Server_Main_CB is
   ...
   type QUIT_ACTION_ENUM is (
     QUIT_ACTION_QUIT_GUI,
     QUIT_ACTION_SHUTDOWN_SERVER_AND_QUIT_GUI);
   ...
   --   and XDG Server configuration file.
   --
   -- IMPLEMENTATION NOTES:
   --   None.
   --
   ...
   --
   -- PURPOSE:
   --   This procedure waits for the DG Server to load the new configuration
   --   file (this happens when the config file changes flag in the interface
   --   becomes False), and then calls XDG_Server.Initialize_Set_Parms_Panels
