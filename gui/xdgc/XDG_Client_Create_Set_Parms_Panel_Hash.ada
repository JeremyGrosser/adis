...
procedure Create_Set_Parms_Panel_Hash(
   ...
   K_Panel_Title        : constant STRING :=
     "XDG Client Hash Parameters Input Screen";
...
begin
   ...
   if (Set_Data.Hash.Shell /= Xt.XNULL) then
	...
	Main_Rowcolumn, "Transmitter Entity Multiplier");
      ...
      Set_Data.Hash.PDU(XDG_Client_Types.ENTITY).Rehash_Increment 
	:= Xt.CreateManagedWidget ("Entity_Rehash_Increment",
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.ENTITY).Site_Multiplier 
	:= Xt.CreateManagedWidget ("Entity_Site_Multiplier",
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.ENTITY).Application_Multiplier 
	:= Xt.CreateManagedWidget ("Entity_Application_Multiplier",
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.ENTITY).Entity_Multiplier 
	...
	Xm.SeparatorWidgetClass, Main_Rowcolumn, Arglist, Argcount);
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.EMITTER).Rehash_Increment
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.EMITTER).Site_Multiplier
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.EMITTER).Application_Multiplier
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.EMITTER).Entity_Multiplier
	...
	Xm.SeparatorWidgetClass, Main_Rowcolumn, Arglist, Argcount);
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.LASER).Rehash_Increment
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.LASER).Site_Multiplier
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.LASER).Application_Multiplier
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.LASER).Entity_Multiplier
	...
	Xm.SeparatorWidgetClass, Main_Rowcolumn, Arglist, Argcount);
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.TRANSMITTER).Rehash_Increment
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.TRANSMITTER).Site_Multiplier
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.TRANSMITTER).Application_Multiplier
        := Xt.CreateManagedWidget ("Transmitter_Application_Multiplier",
          Xm.TextFieldWidgetClass, Main_Rowcolumn, Arglist, Argcount);
      Motif_Utilities.Install_Text_Restrictions (
        Parent           => Set_Data.Hash.PDU(XDG_Client_Types.TRANSMITTER).
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.TRANSMITTER).Entity_Multiplier
	...
	Xm.SeparatorWidgetClass, Main_Rowcolumn, Arglist, Argcount);
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.RECEIVER).Rehash_Increment
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.RECEIVER).Site_Multiplier
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.RECEIVER).Application_Multiplier
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.Nvalue, "");
      Set_Data.Hash.PDU(XDG_Client_Types.RECEIVER).Entity_Multiplier
