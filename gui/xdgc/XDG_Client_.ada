...
--   Self_Mapped : BOOLEAN := False;
   ...
   --
   -- PURPOSE:
   --   This procedure displays the XDG_Client Set Parameters window.
   --
   ...
   --
   -- PURPOSE:
   --   This procedure displays the Set Parameters Synchronization 
   --   Parameters Panel under the passed widget hierarchy.
   --
   -- IMPLEMENTATION NOTES:
   --   None.
   --
   ...
   procedure Initialize_Panel_Synchronization(
      Synchronization : in     
	XDG_Client_Types.XDG_SYNCHRONIZATION_PARAMETERS_DATA_REC);
