...
--
-- PURPOSE:
--   This procedure creates the XDG Client Monitors window.
--
...
procedure Create_Monitors_Window_CB (
   ...
   function "=" (left, right: XDG_Client_Types.XDG_MONITORS_DATA_REC_PTR)
   ...
   function XDG_MONITORS_DATA_REC_PTR_to_Integer is new 
     Unchecked_Conversion (Source => XDG_Client_Types.XDG_MONITORS_DATA_REC_PTR,
                           Target => INTEGER);
...
begin
   ...
   --
      ...
      --
      XDG_Data.Monitors_Data := new XDG_Client_Types.XDG_MONITORS_DATA_REC'(
	Shell                       => Xt.XNULL,
	Title                       => Xt.XNULL,
	...
	Gateway                     => (
      ...
      XDG_Data.Monitors_Data.Error_History := new
        XDG_Client_Types.XDG_MON_ERROR_HISTORY_DATA_REC'(
           Shell                         => Xt.XNULL,
	...
	XDG_Client.K_Monitors_Window_Width);
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xtdef.Nheight,
	XDG_Client.K_Monitors_Window_Height);
      Argcount := Argcount + 1;
	...
	" Cancel ");
	  ...
	  XDG_Client.Close_Window_CB'address, XDG_Data.Monitors_Data.Shell);
	...
	Parameter_Selection_Scrolled_Window, Arglist, Argcount);
      ...
      --  XDG_Client.Create_Monitors_Panel_Entities'address, 
      --  XDG_Client_Types.XDG_MONITORS_DATA_REC_PTR_to_XtPOINTER(
      --    XDG_Data.Monitors_Data));
--
--      Gateway_Button := Motif_Utilities.Create_Pushbutton (
--	Parameter_Selection_Rowcolumn, " Gateway ");
--      Xt.AddCallback (Gateway_Button, Xmdef.NactivateCallback,
--	XDG_Client.Create_Monitors_Panel_Gateway'address, 
--        XDG_Client_Types.XDG_MONITORS_DATA_REC_PTR_to_XtPOINTER(
--	  XDG_Data.Monitors_Data));
	...
	XDG_Client.Create_Monitors_Panel_Errors'address, 
        XDG_Client_Types.XDG_MONITORS_DATA_REC_PTR_to_XtPOINTER(
	  XDG_Data.Monitors_Data));
