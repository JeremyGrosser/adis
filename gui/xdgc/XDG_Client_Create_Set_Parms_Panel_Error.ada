...
procedure Create_Set_Parms_Panel_Error(
   ...
   K_Panel_Title        : constant STRING :=
     "XDG Client Error Parameters Input Screen";
   ...
   --
   GUI_Error_Reporting_Menu : XDG_Client.ENABLED_DISABLED_OPTION_MENU_TYPE;
   ...
   Error_Logging_Menu : XDG_Client.ENABLED_DISABLED_OPTION_MENU_TYPE;
...
begin
   ...
   if (Set_Data.Error.Shell /= Xt.XNULL) then
	...
	menu_item   => GUI_Error_Reporting_Menu(XDG_Client.
	...
	Xm.PushButtonGadgetClass, TRUE, ASCII.NUL, "", "",
	  Motif_Utilities.Set_Boolean_Value_CB'address,
		...
		GUI_Error_Reporting_Disabled_Pushbutton,
	          GUI_Error_Reporting_Menu(XDG_Client.ENABLED_DISABLED_ENUM'pos(
	            XDG_Client.DISABLED)));
	...
	XDG_Client.GUI_Error_Reporting_Flag'address);
	...
	menu_item   => Error_Logging_Menu(XDG_Client.
	  ENABLED_DISABLED_ENUM'pos(XDG_Client.ENABLED)));
	...
	Xm.PushButtonGadgetClass, TRUE, ASCII.NUL, "", "",
	  Motif_Utilities.Set_Boolean_Value_CB'address,
		...
		Error_Logging_Disabled_Pushbutton,
	          Error_Logging_Menu(XDG_Client.ENABLED_DISABLED_ENUM'pos(
	            XDG_Client.DISABLED)));
	...
	return_widget    => Error_Logging_Menu_Cascade);
      ...
      Argcount := Argcount + 1;
      Xt.SetArg (Arglist (Argcount), Xmdef.NuserData,
	XDG_Client.Error_Logging_Flag'address);
