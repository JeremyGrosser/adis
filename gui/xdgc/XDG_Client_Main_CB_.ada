...
package XDG_Client_Main_CB is
   ...
   --   and XDG Client configuration file.
   --
   -- IMPLEMENTATION NOTES:
   --   None.
   --
   ...
   --
   -- PURPOSE:
   --   This procedure waits for the DG Client to load the new configuration
   --   file (this happens when the config file changes flag in the interface
   --   becomes False), and then calls XDG_Client.Initialize_Set_Parms_Panels
