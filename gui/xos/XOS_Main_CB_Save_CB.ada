...
--   XOS screens into a configuration file.
--
...
--    --
--    if (OS_GUI.Interface.Configuration_File.Length > 0) then
--
--       Xm.TextSetString (Xm.FileSelectionBoxGetChild (File_Selection_Box,
--	 Xm.DIALOG_TEXT), OS_GUI.Interface.Configuration_File.Name(
--	   OS_GUI.Interface.Configuration_File.Name'first..
--	     OS_GUI.Interface.Configuration_File.Name'first
--	       + OS_GUI.Interface.Configuration_File.Length - 1));
--    else
--       Xm.TextSetString (Xm.FileSelectionBoxGetChild (File_Selection_Box,
--	 Xm.DIALOG_TEXT), XOS_Types.K_Default_Config_Filename);
--    end if;
    ...
    Xt.AddCallback (File_Selection_Box, Xmdef.NokCallback,
      XOS_Main_CB.Save_Config_File_FSB_CB'address,
