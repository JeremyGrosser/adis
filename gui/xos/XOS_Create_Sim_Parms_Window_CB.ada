...
procedure Create_Sim_Parms_Window_CB (
   ...
   Parameter_Selection_Scrolled_Window : Xt.WIDGET;
      Parameter_Selection_Rowcolumn    : Xt.WIDGET;
         Simulation_Parameters_Button  : Xt.WIDGET;
   ...
   function XOS_PARM_DATA_REC_PTR_to_Integer is new 
     Unchecked_Conversion (Source => XOS_Types.XOS_PARM_DATA_REC_PTR,
                           Target => INTEGER);
   function XOS_SIM_PARM_DATA_REC_PTR_to_Integer is new 
...
begin
   ...
   --
   if ((XOS_Data.Sim_Data /= NULL) and then 
     (XOS_Data.Sim_Data.Shell /= Xt.XNULL)) then

      Xt.ManageChild (XOS_Data.Sim_Data.Shell);
      Xt.Popup (XOS_Data.Sim_Data.Shell, Xt.GrabNone);
      Xlib.MapRaised (
	Xt.GetDisplay (XOS_Data.Sim_Data.Shell), 
	Xt.GetWindow (XOS_Data.Sim_Data.Shell));
   ...
   --
      ...
      -- Allocate Sim_Data
      --
      XOS_Data.Sim_Data := new XOS_Types.XOS_SIM_PARM_DATA_REC'(
	Shell                       => Xt.XNULL,
	Title                       => Xt.XNULL,
	...
	INTEGER(Xm.DO_NOTHING));
      XOS_Data.Sim_Data.Shell := Xt.CreatePopupShell (K_Title,
	...
	XOS_Data.Sim_Data.Shell), "WM_DELETE_WINDOW", False);
      Xm.AddWMProtocolCallback (XOS_Data.Sim_Data.Shell, WM_Delete_Window,
	XOS.Close_Window_CB'address, XOS_Data.Sim_Data.Shell);
	...
	Xm.FormWidgetClass, XOS_Data.Sim_Data.Shell, Arglist, Argcount);
      ...
      Xt.AddCallback (Apply_Button, Xmdef.NactivateCallback,
         XOS.Sim_Apply_CB'address,
           XOS_Types.XOS_SIM_PARM_DATA_REC_PTR_to_XtPOINTER(
             XOS_Data.Sim_Data));
	...
	" Cancel ");
      ...
      Xt.AddCallback (Cancel_Button, Xmdef.NactivateCallback, 
        XOS.Cancel_Sim_Parms_Window_CB'address,
          XOS_Types.XOS_SIM_PARM_DATA_REC_PTR_to_XtPOINTER(XOS_Data.Sim_Data));
      ...
      Xt.SetArg (Arglist (Argcount), Xmdef.NrightOffset, 
        Motif_Utilities.Widget_Separation);
      XOS_Data.Sim_Data.Description := Xt.CreateManagedWidget ("Description",
	...
	Parameter_Selection_Scrolled_Window, Arglist, Argcount);
      ...
      --
      -- Create the Simulation Parameters Button
      --
      Simulation_Parameters_Button := Motif_Utilities.Create_Pushbutton (
	Parameter_Selection_Rowcolumn,
	" Simulation " & ASCII.LF & " Parameters ");
      Xt.AddCallback (Simulation_Parameters_Button, Xmdef.NactivateCallback,
	XOS.Create_Sim_Panel_Sim'address, 
	XOS_Types.XOS_SIM_PARM_DATA_REC_PTR_to_XtPOINTER(XOS_Data.Sim_Data));
	...
	Parameter_Selection_Scrolled_Window);
      ...
      --
      XOS_Data.Sim_Data.Title := Motif_Utilities.Create_Label (
      ...
      Xt.SetArg (Arglist (Argcount), Xmdef.NrightOffset,
        Motif_Utilities.Widget_Separation);
      Xt.SetValues (XOS_Data.Sim_Data.Title, Arglist, Argcount);
      ...
      Xt.SetArg (Arglist (Argcount), Xmdef.NrightOffset, 
        Motif_Utilities.Widget_Separation);
      XOS_Data.Sim_Data.Parameter_Scrolled_Window := Xm.CreateScrolledWindow (
        Work_Form, "Parameter_Scrolled_Window", Arglist, Argcount);
      Xt.ManageChild (XOS_Data.Sim_Data.Parameter_Scrolled_Window);
...
end Create_Sim_Parms_Window_CB;
