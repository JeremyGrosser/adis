...
-- Unit Name:          Az_And_El
--
-- File Name:          Filter_By_PDU_Cmpnts__Az_And_El.ada
--
...
separate (Filter_By_PDU_Components)
...
begin  -- Az_And_El
   ...
   Coordinate_Conversions.Geocentric_To_Entity_Conversion(
     ...
     Entity_Coordinate_System_Center => Location,
...
exception
   ...
   when OTHERS       => 
      Status  := DL_Status.FILT_PDU_AZ_AND_EL_FAILURE; 
