...
--=============================================================================
--
-- Unit Name:          Maximum_Velocity
--
-- File Name:          Filter__Maximum_Velocity.ada
--
...
-- Purpose:
--
--   Determines whether the velocity magnitude of an entity or event is less
--   than or equal to a specificed maximum velocity magnitude.
--
-- Implementation:
--
...
exception
   ...
   when OTHERS       => 
      Status  := DL_Status.FILT_MAX_VEL_FAILURE; 
